...
public class DatabaseManagementProgram {
    static final String JDBC_DRIVER = "com.mysql.cj.jdbc.Driver";
    static final String DB_URL = "jdbc:mysql://localhost/JavaDB";
    static final String USER = "root"; // Your MySQL username
    static final String PASS = "BB11@root"; // Your MySQL password
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            do {
            	System.out.println("\nBelow are the operations that can be performed : ");
    ...
    private static void performInsertOperation(Connection conn) throws SQLException {
        ...
        switch (tableChoice) {
            ...
            case 4:
            {
                ...
                String sql = "INSERT INTO HospitalDepartment " + "VALUES (?, ?, ?, ?, ?, ?)";
                PreparedStatement preparedStatement = conn.prepareStatement(sql);
                ...
                switch(ch2)
                {
                	...
                	case 12 : 
                	{
                		try {
            	        	...
            	        	PreparedStatement preparedStatement = conn.prepareStatement(sql);
            	        	preparedStatement.setInt(1, emer);
            	        	int rowsDeleted = preparedStatement.executeUpdate();
            	        	if (rowsDeleted > 0) 
            	        	{
        	...
        	case 3 :
        	{
                ...
                case 2 :
                {
                	try 
                	{
        	        	...
        	        	PreparedStatement preparedStatement = conn.prepareStatement(sql);
        	        	preparedStatement.setInt(1, h_h);
        	        	int rowsDeleted = preparedStatement.executeUpdate();
        	        	if (rowsDeleted > 0) 
        	        	{
                ...
                switch(ch6)
                {
                	...
                	case 6 :
                	{
                		try 
                		{
            	        	...
            	        	PreparedStatement preparedStatement = conn.prepareStatement(sql);
            	        	preparedStatement.setString(1, Visit_Price);
            	        	int rowsDeleted = preparedStatement.executeUpdate();
            	        	if (rowsDeleted > 0) 
            	        	{
                	...
                	case 7 :
                	{
                		try {
            	        	...
            	        	PreparedStatement preparedStatement = conn.prepareStatement(sql);
            	        	preparedStatement.setString(1, Followup_Price);
            	        	int rowsDeleted = preparedStatement.executeUpdate();
            	        	if (rowsDeleted > 0) 
            	        	{
                	...
                	case 8 :
                	{
                		try 
                		{
            	        	...
            	        	PreparedStatement preparedStatement = conn.prepareStatement(sql);
            	        	preparedStatement.setString(1, Inpateint_Visit_Price);
            	        	int rowsDeleted = preparedStatement.executeUpdate();
            	        	if (rowsDeleted > 0) 
            	        	{
